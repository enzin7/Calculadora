...
// Variáveis Globais
export let historico: string[] = [];

// --- Funções de Histórico ---
export function atualizarHistorico(): void {
...
export function contaVelha(conta: string) {
  setEntrada(conta);
  atualizarDisplay();
}
...
export function antigaConta(): void {
  let antigaConta: string = historico[historico.length - 1];
  let i: number = antigaConta.lastIndexOf("=");
